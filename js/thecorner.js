...
/* touch-events */ (function(e, t) {
    e.each("touchstart touchmove touchend orientationchange tap taphold swipe swipeleft swiperight scrollstart scrollstop".split(" "), function(t, n) {
        e.fn[n] = function(e) {
    ...
    e.event.special.scrollstart = {
        ...
        setup: function() {
            function o(n, r) {
                i = r;
                var s = n.type;
                n.type = i ? "scrollstart" : "scrollstop";
                e.event.handle.call(t, n);
                n.type = s
            }
            var t = this,
                n = e(t),
        ...
        setup: function() {
            ...
            n.bind(i, function(r) {
                function p(e) {
                    ...
                    var t = e.type == "touchmove" ? e.originalEvent.touches[0] : e;
                    if (Math.abs(l[0] - t.pageX) > 10 || Math.abs(l[1] - t.pageY) > 10) {
                        i = true
                    }
                }
                if (r.which && r.which !== 1 || n.data("prevEvent") && n.data("prevEvent") !== r.type) {
                    return false
                }
                n.data("prevEvent", r.type);
                setTimeout(function() {
                    n.removeData("prevEvent")
                }, 800);
                var i = false,
                    u = true,
                    a = r.target,
                    f = r.originalEvent,
                    l = r.type == "touchstart" ? [f.touches[0].pageX, f.touches[0].pageY] : [r.pageX, r.pageY],
                    c, h;
                ...
                e(window).one("scroll", p);
                n.bind(o, p).one(s, function(r) {
                    n.unbind(o, p);
                    e(window).unbind("scroll", p);
                    clearTimeout(h);
                    u = false;
                    if (!i && a == r.target) {
                        c = r.type;
        ...
        setup: function() {
            ...
            r.bind(i, function(n) {
                function f(e) {
                    ...
                    if (Math.abs(u.coords[0] - a.coords[0]) > 10) {
                        e.preventDefault()
                    }
                }
                var i = n.originalEvent.touches ? n.originalEvent.touches[0] : n,
                    u = {
                        time: (new Date).getTime(),
                        coords: [i.pageX, i.pageY],
                        origin: e(n.target)
                    }, a;
                r.bind(o, f).one(s, function(e) {
                    r.unbind(o, f);
                    if (u && a) {
                        if (a.time - u.time < 1e3 && Math.abs(u.coords[0] - a.coords[0]) > 30 && Math.abs(u.coords[1] - a.coords[1]) < 75) {
                            u.origin.trigger("swipe").trigger(u.coords[0] > a.coords[0] ? "swipeleft" : "swiperight")
                        }
                    }
                    u = a = t
                })
    ...
    (function(e) {
        ...
        var t = e(window),
            n, r, i;
        e.event.special.orientationchange = n = {
            setup: function() {
        ...
        n.orientation = r = function() {
            var e = document.documentElement;
            return e && e.clientWidth / e.clientHeight < 1.1 ? "portrait" : "landscape"
        }
    })(jQuery);
    e.each({
